...
public class JsonMapper {
    ...
    public static JsonMapper NON_EMPTY_MAPPER = new JsonMapper(Include.NON_NULL );
    ...
    public JsonMapper(Include include) {
        ...
        SimpleModule module = new SimpleModule("CalmDatesModule", new Version(0, 1, 0, "alpha", "com.keruyun", "calm"));
