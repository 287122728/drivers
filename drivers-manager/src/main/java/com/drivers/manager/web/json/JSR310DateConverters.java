package com.drivers.manager.web.json;
...
public final class JSR310DateConverters {
    ...
    public static class ZonedDateTimeToTimestampConverter implements Converter<ZonedDateTime, Timestamp> {
        public static final ZonedDateTimeToTimestampConverter INSTANCE = new ZonedDateTimeToTimestampConverter();
        private ZonedDateTimeToTimestampConverter() {}

        @Override
        public Timestamp convert(ZonedDateTime source) {
            return source == null ? null : new Timestamp(source.toEpochSecond()) ;
        }
    }

    public static class TimestampToZonedDateTimeConverter implements Converter<Timestamp, ZonedDateTime> {
        public static final TimestampToZonedDateTimeConverter INSTANCE = new TimestampToZonedDateTimeConverter();
        private TimestampToZonedDateTimeConverter() {}
